...
class SweepArgs:
    ...
    study_name: str = "ppo_atari_soap_rollout_hp_sweep"
    storage: str = ""
    env_id: str = "ale_py:QbertNoFrameskip-v4"
...
def build_params_fn(args: SweepArgs):
    def params(trial: optuna.Trial):
        return {
            ...
            "exp-name": f"ppo_atari_soap_rollout_hp_sweep_t{trial.number}",
            ...
            "clip-coef": 0.1,
            "ent-coef": 0.01,
            "soap-normalize-grads": True,
            "soap-precondition-frequency": 1,
            # Sweep targets
            "learning-rate": trial.suggest_float("learning-rate", 3e-6, 3e-4, log=True),
...
def main():
    ...
    # Save under runs/soap_rollout_hp_sweep/<run_name>
    os.environ["RUN_GROUP"] = "soap_rollout_hp_sweep"
