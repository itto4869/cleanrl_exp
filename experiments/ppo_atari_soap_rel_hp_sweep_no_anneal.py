...
class SweepArgs:
    ...
    study_name: str = "ppo_atari_soap_rel_hp_sweep_no_anneal"
    storage: str = ""
...
def build_params_fn(args: SweepArgs):
    def params(trial: optuna.Trial):
        return {
            ...
            "exp-name": f"ppo_atari_soap_rel_hp_sweep_no_anneal_t{trial.number}",
...
def main():
    ...
    # Save under runs/soap_sweep_no_anneal/<run_name>
    os.environ["RUN_GROUP"] = "soap_sweep_no_anneal"
