...
class SweepArgs:
    ...
    study_name: str = "ppo_atari_soap_hp_sweep"
    storage: str = ""
...
def build_params_fn(args: SweepArgs):
    def params(trial: optuna.Trial):
        return {
            ...
            "exp-name": f"ppo_atari_soap_hp_sweep_t{trial.number}",
            "total-timesteps": args.total_timesteps,
            # Fixed baselines (match SOAP-Rel sweep)
            "num-envs": 8,
            "num-steps": 128,
            "num-minibatches": 4,
            "update-epochs": 4,
...
def main():
    ...
    # Save under runs/soap_hp_sweep/<run_name>
    os.environ["RUN_GROUP"] = "soap_hp_sweep"
